...
/*   Updated: 2018/01/18 17:37:00 by pde-rent         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	char	**input_reader(char *file, int hypo_blocks)
{
	...
	i = -1;
	IS_CHAR((output = (char **)malloc(sizeof(char *) * hypo_blocks)));
	while (++i < hypo_blocks)
		IS_CHAR((output[i] = (char *)malloc(sizeof(char) * 22)));
	i = 0;
